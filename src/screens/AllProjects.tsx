...
function Timetracker() {
    ...
    const handleSubmit = (id: string, name: string, priority: 'Normal' | 'Urgent' | 'High', assignee: string) => {
    ...
    <Button onClick={toggleAddProject} className={`flex ${filteredProjects.length === 0 && 'hidden'} w-[200px] items-center`}>
        <PlusCircle />
        <p className="mr-1">Add new project</p>
            ...
            <div className=" pb-10 mx-4 " style={{ display: 'flex', flexWrap: 'wrap' }}>
                ...
                {filteredProjects.length === 0 && (
                    <div className='flex justify-center items-center  w-full h-full'>
                        ...
                        <div className='flex items-center h-[12rem] p-4 mx-4 rounded-md shadow-lg  gap-5 flex-col justify-center bg-white '>
                            <div>
                                     <span>
                        Hey there, you have no projects available yet 
                        </span>
