...
interface AddProjectProps {
    onClose: () => void;
    handleSubmit: (id: string, name: string, priority: Priority, assignee: string) => void; 
}
                    ...
                    <CardHeader>
                        <div className="flex items-center justify-between">
                            <div>
                                ...
                                <CardDescription>create and assign project here❤️</CardDescription>
                            </div>
                            {priority && (
                            ...
                            <div className="flex flex-col space-y-1.5">
                                ...
                                <Select onValueChange={(value) => setPriority(value as Priority)}>
                                    ...
                                    <SelectContent position="popper">
                                        <SelectItem value="High" className="hover:bg-amber-100">High</SelectItem>
                                        <SelectItem value="Urgent" className="hover:bg-red-100">Urgent</SelectItem>
                                        <SelectItem value="Normal" className="hover:bg-green-100">Normal</SelectItem>
                                    </SelectContent>
                                </Select>
                            </div>
                        </div>
